      ...
      <nav class="navbar-default navbar-static-side" role="navigation">
          <div class="sidebar-collapse">
              <ul class="nav" id="side-menu">
                 ...
                 <form name="myform" id="myform" action="<?php echo base_url() ?>index/getarticle" method="post">
                 <input type="hidden" name="code" id="id" value="<?php echo $row['id'] ?>" />
                 <input type="submit" length="60" class="btn btn-primary " value="<?php echo $row['title'] ?>" />
                 </form>
                  </li>
                  <?php
                  }}
    ...
    -->
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Chiromo Campus Christian Union</span>
                </li>
                <li class="dropdown">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="index.html">CCCU</a>
                        </li>
                        <li>
                            <a>Articles</a>
                        </li>
                        <li class="active">
                            <strong><?php $row['title']; ?></strong>
                        </li>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <button class="btn btn-white btn-xs" type="button">Author ~~<?php echo $row['name']; ?></button>
                                </div>
                                <div class="col-md-6">
        ...
        <div class="footer">
            ...
            <div>
                <strong>Copyright</strong> CCCU-ICT Team &copy; 2015-2016
            </div>
        </div>
